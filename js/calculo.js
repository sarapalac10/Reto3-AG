...
function crearRegistro() {
    ...
    //Crear al objeto
  objRegistrado = new Registro(sexoFormulario, edadFormulario, pesoFormulario, alturaFormulario, calculo_imc, resultado1);
  ...
  console.log("El registro es: " + objRegistradoRecibido.Sexo + " " + objRegistradoRecibido.Edad + " " + objRegistradoRecibido.Peso + " " + objRegistradoRecibido.Altura) ;
    ...
    function imprimirTabla () {
      ...
      for (var i = 0; i < lista.length; i++) {
          ...
          imcCelda.innerHTML = lista[i].imc;
          clasifCelda.innerHTML = lista[i].clasificacion;
